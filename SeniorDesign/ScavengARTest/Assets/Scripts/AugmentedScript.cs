...
public class AugmentedScript : MonoBehaviour
{
    ...
    private GameObject latitudeTextObject;
    private GameObject longitudeTextObject;
    ...
    IEnumerator GetCoordinates()
    {
        ...
        while (true)
        {
            ...
            else
            {
                ...
                latitudeTextObject.GetComponent<UnityEngine.UI.Text>().text = "Latitude: " + currentLatitude;
                currentLongitude = Input.location.lastData.longitude;
                longitudeTextObject.GetComponent<Text>().text = "Longitude" + currentLongitude;
    ...
    public void Calc(float lat1, float lon1, float lat2, float lon2)
    {
        ...
        distanceTextObject.GetComponent<UnityEngine.UI.Text>().text = "Distance: " + distance;
